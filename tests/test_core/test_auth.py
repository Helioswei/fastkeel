...
class TestCreateToken:
    ...
    def test_create_token_returns_string(self):
        config = Config(jwt_secret="test-secret-0123456789abcdef1234")
...
class TestVerifyToken:
    ...
    def test_verify_expired_token_raises_401(self):
        ...
        config = Config(jwt_secret="test-secret-0123456789abcdef1234", jwt_expire_hours=-1)
        token = create_token("user-1", config)
    ...
    def test_verify_wrong_secret_raises_401(self):
        config1 = Config(jwt_secret="secret-1-0123456789abcdefghijklm")
        config2 = Config(jwt_secret="secret-2-0123456789abcdefghijklm")
